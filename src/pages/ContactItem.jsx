        ...
        <div>
            <div className="skill">
                ...
                <div className="skill_item skill_data">
                    ...
                    <Link to='/resume' style={{ padding: '10px', cursor: 'pointer', background: 'var(--text-color)', color: 'var(--background-color)', fontWeight: '500', borderRadius: '5px' }}>
                        My Resume
                    </Link>
                </div>
            </div>
            ...
            <div className="skill">
                <div className="skill_item skill_data i2d">
                    ...
                    <Link className='more_items' to='https://medium.com/@surajmshivakumar' >Visit My Blogsite</Link>
                </div>
